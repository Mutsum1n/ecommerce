...
(5, 'seller2', '$2a$10$BVuSir5tn3USI7Pg0NDy0e3fj21jyUS4AR2ECNkZuzx8cEQ0rOeKS', '王五', 'seller2@test.com', '13800000005', 'SELLER', NOW(), NOW());
...
(3, '无线耳机', '蓝牙无线耳机，降噪功能，24小时续航', 399.00, 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400', 100, 5, true, NOW(), NOW()),
...
-- 插入订单项
INSERT INTO order_items (id, order_id, product_id, quantity, unit_price, subtotal, created_at, seller_id)
VALUES
(1, 1, 1, 1, 2999.00, 2999.00, DATEADD('DAY', -5, NOW()), 2),
(2, 1, 3, 1, 399.00, 399.00, DATEADD('DAY', -5, NOW()), 5),
(3, 2, 4, 1, 1299.00, 1299.00, DATEADD('DAY', -3, NOW()), 2),
(4, 3, 2, 1, 6999.00, 6999.00, DATEADD('DAY', -7, NOW()), 2);
